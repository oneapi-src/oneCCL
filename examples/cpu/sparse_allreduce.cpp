...
struct sparse_value_type_iterator {
    ...
    void invoke(ccl_sparse_coalesce_mode_t coalesce_mode,
        ...
        ccl_tuple_for_each_indexed<types>(
            sparse_algo_iterator<i_type::ccl_type::value>(), coalesce_mode, callback_mode);
    }
};
...
int main(int argc, char** argv) {
    ...
    using supported_sparce_index_types =
        sparce_index_types<ccl_dtype_char, ccl_dtype_int, ccl_dtype_int64, ccl_dtype_uint64>::types;
    ...
    ccl_tuple_for_each_indexed<supported_sparce_index_types>(
        supported_sparce_value_types(), coalesce_mode, callback_mode);

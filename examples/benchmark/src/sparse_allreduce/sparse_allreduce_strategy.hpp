...
ccl_status_t sparse_allreduce_alloc_fn(
    size_t ind_count, ccl_datatype_t ind_dtype,
    size_t val_count, ccl_datatype_t val_dtype,
    const void* fn_ctx,
    void** out_ind_buf, void** out_val_buf)
{

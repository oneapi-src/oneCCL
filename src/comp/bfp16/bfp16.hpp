...
#ifdef CCL_BFP16_TARGET_ATTRIBUTES
#ifdef CCL_BFP16_AVX512BF_COMPILER
void ccl_convert_fp32_to_bfp16(const void* src, void* dst) __attribute__((target("avx512bw,avx512bf16")));
#else
...
#ifdef CCL_BFP16_TARGET_ATTRIBUTES
#ifdef CCL_BFP16_AVX512BF_COMPILER
void ccl_convert_bfp16_to_fp32(const void* src, void* dst) __attribute__((target("avx512bw,avx512bf16")));
#else

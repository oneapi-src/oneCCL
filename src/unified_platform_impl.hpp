...
generic_platform_type<CCL_ENABLE_SYCL_TRUE>::get() noexcept {
    return const_cast<generic_platform_type<CCL_ENABLE_SYCL_TRUE>::ccl_native_t>(
        static_cast<const generic_platform_type<CCL_ENABLE_SYCL_TRUE>*>(this)->get());
}
...
generic_platform_type<CCL_ENABLE_SYCL_FALSE>::get() noexcept {
    return const_cast<generic_platform_type<CCL_ENABLE_SYCL_FALSE>::ccl_native_t>(
        static_cast<const generic_platform_type<CCL_ENABLE_SYCL_FALSE>*>(this)->get());
}

...
struct host_attr_impl : public ccl_host_comm_attr_t {
    ...
    const int& get_attribute_value(
        std::integral_constant<ccl_host_attributes, ccl_host_attributes::ccl_host_color> stub)
        const;
    const ccl_version_t& get_attribute_value(
        std::integral_constant<ccl_host_attributes, ccl_host_attributes::ccl_host_version> stub)
        const;
...
struct device_attr_impl {
    ...
    const device_topology_type& get_attribute_value(
        std::integral_constant<ccl_device_attributes,
                               ccl_device_attributes::ccl_device_preferred_topology_class> stub)
        const;
    const device_group_split_type& get_attribute_value(
        std::integral_constant<ccl_device_attributes,

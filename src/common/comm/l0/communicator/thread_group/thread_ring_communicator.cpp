...
COMM_INTERFACE_COLL_CLASS_INSTANTIATIONS(thread_device_group_ring_communicator,
...
COMM_INTERFACE_SPARSE_ALLREDUCE_EXPLICIT_INSTANTIATION(thread_device_group_ring_communicator,
                                                       char,
                                                       char);
COMM_INTERFACE_SPARSE_ALLREDUCE_EXPLICIT_INSTANTIATION(thread_device_group_ring_communicator,
                                                       char,

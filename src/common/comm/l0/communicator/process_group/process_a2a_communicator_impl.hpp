...
process_a2a_communicator::allgatherv_impl(const buffer_type* send_buf,
                                          size_t send_count,
...
template<class buffer_type>
ccl::communicator::coll_request_t
process_a2a_communicator::alltoall_impl(const buffer_type* send_buf,
                                        buffer_type* recv_buf,
                                        size_t count,
                                        const ccl::coll_attr* attr,
                                        ccl::stream::impl_t& stream)
...
template<class buffer_type>
ccl::communicator::coll_request_t
process_a2a_communicator::alltoallv_impl(const buffer_type* send_buf,
...
/* bcast */
template<class buffer_type>
ccl::communicator::coll_request_t process_a2a_communicator::bcast_impl(buffer_type* buf,
                                             size_t count,
                                             size_t root,
                                             const ccl::coll_attr* attr,
                                             ccl::stream::impl_t& stream)
...
template<class buffer_type>
ccl::communicator::coll_request_t
process_a2a_communicator::bcast_impl(buffer_type& buf,
                                     size_t count,
                                     size_t root,
                                     const ccl::coll_attr* attr,
                                     ccl::stream::impl_t& stream)
...
template<class buffer_type>
ccl::communicator::coll_request_t
process_a2a_communicator::reduce_impl(const buffer_type* send_buf,
                                      buffer_type* recv_buf,
                                      size_t count,
                                      ccl::reduction reduction,
                                      size_t root,

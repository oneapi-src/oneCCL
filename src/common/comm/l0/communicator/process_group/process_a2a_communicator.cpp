...
/* bcast */
ccl::communicator::coll_request_t
process_a2a_communicator::bcast_impl(void* buf,
                                     size_t count,
                                     ccl_datatype_t dtype,
                                     size_t root,
                                     const ccl::coll_attr* attr,
...
COMM_INTERFACE_COLL_INSTANTIATIONS(process_a2a_communicator, double);
    ...
    COMM_INTERFACE_COLL_CLASS_INSTANTIATIONS(process_a2a_communicator, cl::sycl::buffer<int64_t COMMA 1>);
    COMM_INTERFACE_COLL_CLASS_INSTANTIATIONS(process_a2a_communicator, cl::sycl::buffer<uint64_t COMMA 1>);
    COMM_INTERFACE_COLL_CLASS_INSTANTIATIONS(process_a2a_communicator, cl::sycl::buffer<float COMMA 1>);
    COMM_INTERFACE_COLL_CLASS_INSTANTIATIONS(process_a2a_communicator, cl::sycl::buffer<double COMMA 1>);
...
COMM_INTERFACE_SPARSE_ALLREDUCE_EXPLICIT_INSTANTIATION(process_a2a_communicator, int64_t, ccl::bfp16);
...
COMM_INTERFACE_SPARSE_ALLREDUCE_EXPLICIT_INSTANTIATION(process_a2a_communicator, uint64_t, ccl::bfp16);
...
COMM_INTERFACE_SPARSE_ALLREDUCE_EXPLICIT_INSTANTIATION(process_a2a_communicator, uint64_t, uint64_t);

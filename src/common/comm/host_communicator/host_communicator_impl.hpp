...
host_communicator::allgatherv_impl(const buffer_type* send_buf,
                                   size_t send_count,
...
template<class buffer_type>
ccl::communicator::coll_request_t
host_communicator::allreduce_impl(const buffer_type* send_buf,
                                  buffer_type* recv_buf,
                                  size_t count,
...
template<class buffer_type>
ccl::communicator::coll_request_t
host_communicator::alltoall_impl(const buffer_type* send_buf,
                                 buffer_type* recv_buf,
                                 size_t count,
                                 const ccl::coll_attr* attr,
                                 ccl::stream::impl_t& stream)
...
template<class buffer_type>
ccl::communicator::coll_request_t
host_communicator::alltoallv_impl(const buffer_type* send_buf,
...
template<class buffer_type>
ccl::communicator::coll_request_t
host_communicator::reduce_impl(const buffer_type* send_buf,
                               buffer_type* recv_buf,
                               size_t count,
                               ccl::reduction reduction,
                               size_t root,
